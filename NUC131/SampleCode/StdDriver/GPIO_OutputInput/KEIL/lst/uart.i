...
void UART_ClearIntFlag(UART_T* uart , uint32_t u32InterruptFlag)
{
    ...
    if(u32InterruptFlag & (1ul << 16))    
    {
        uart->ISR = (1ul << 16);
    }

    if(u32InterruptFlag & (1ul << 17))    
    {
        uart->ISR = (1ul << 17);
    }
...
void UART_DisableInt(UART_T*  uart, uint32_t u32InterruptFlag)
{
    ...
    else if(uart == ((UART_T *) ((( uint32_t)0x40100000) + 0x54000)))
        NVIC_DisableIRQ(UART02_IRQn);
    else if(uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x54000)))
        NVIC_DisableIRQ(UART3_IRQn);
    else if(uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x58000)))
