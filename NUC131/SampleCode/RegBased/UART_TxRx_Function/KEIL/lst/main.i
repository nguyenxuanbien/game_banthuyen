...
void SYS_Init(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~(3ul << 24))) | (0x0UL<<24);
...
void UART_TEST_HANDLE()
{
    ...
    if(u32IntSts & (1ul << 8))
    {
        ...
        while(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->ISR & (1ul << 0))
        {
    ...
    if(u32IntSts & (1ul << 9))
    {
        ...
        if(g_u32comRhead != tmp)
        {
            ...
            while((((((UART_T *) ((( uint32_t)0x40000000) + 0x50000)))->FSR & (1ul << 23))>>23));                              
